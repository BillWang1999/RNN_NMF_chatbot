...
seq2seq.trainIters(model_name, d.voc, d.pairs, d.pairs_validation, encoder, decoder, encoder_optimizer, decoder_optimizer,
           embedding, encoder_n_layers, decoder_n_layers, d.save_dir, n_iteration, batch_size,
           print_every, save_every, clip, d.corpus_name, loadFilename)